...
const SearchBar = () => {
  return (
    <div className="w-full text-sm bg-white p-6 border">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text flex bg-gray-100  h-14 rounded-full shadow-md px-3 justify-between py-2 space-x-5">
          {/* Location Selector */}
          <div className="flex items-center space-x-2 px-4 bordr-r border-white bg-white rounded-full">
          ...
          {/* Available From Date */}
          <div className="flex items-center space-x-2 px-4 border-r border-white bg-white rounded-full flex-1">
          ...
          {/* Rooms Selector */}
          <div className="flex items-center space-x-2 px-4 min-w-0 flex-1">
            <Select>
              <SelectTrigger className="border-none shadow-none p-0 h-auto focus:ring-0">

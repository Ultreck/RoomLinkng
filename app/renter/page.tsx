    ...
    <>
      ...
      <div className="flex flex-col max-w-full mx-auto p-5 space-y-6">
        <div className="grid w-full grid-cols-5 space-x-5 gap-5">
          <div
            className={`text w-full mx-auto  ${
              isSearched ? "col-span-5 sm:col-span-3" : "col-span-5"
            } `}
          >
            <RoomSection
          ...
          {isSearched && (
            <div className="text hidden lg:col-span-2 border  lg:flex">
              <Image
                src={img}
                alt={"map"}
                // fill
                width={600}
                height={700}
                className="group-hover:scale-105 object-fit transition-transform duration-300"
              />
            </div>
          )}
        </div>
